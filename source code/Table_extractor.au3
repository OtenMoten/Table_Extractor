...
Global $guiLoadingScreen, $guiProgressLoadingScreen, $guiMain, $guiEmbeddedBrowser, $guiControlPanel, _
		$lbHeader, _
		$btnTabula, $btnMendeley, $btnOpenoffice, $btnJava, $btnWizard, $btnHome, $btnExitEmbedded, $btnExit, _
...
Func _On_Button()
	...
	Switch @GUI_CtrlId ;Check which button sent the message
		...
		Case $btnKillSpaces
			...
			MsgBox($MB_SYSTEMMODAL, "btnKillSpaces", "Successful")
		...
		Case $btnSave
			...
			MsgBox($MB_SYSTEMMODAL, "btnSave", "Successful")
...
Func _Start_GUI_Main()
	...
	$btnJava = GUICtrlCreateButton("Placeholder", (@DesktopWidth / 3), (@DesktopHeight / 1.124), (@DesktopWidth / 5), (@DesktopHeight / 15))
	GUICtrlSetFont(-1, 12, 600, 0, "Leelawadee")
	GUICtrlSetColor(-1, 0x000000)
	GUICtrlSetOnEvent(-1, "_On_Button")
...
Func _Start_Mendeley_with_AutoImport()
	...
	;;; Prozi zum Abfangen bei Crashs

	WinWait("Mendeley Desktop")
	Sleep(500)
